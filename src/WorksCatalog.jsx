    ...
    () => [
      {
        ...
        summary: "【Youtubeショートにて総再生数2500万回以上を記録した、あるみらんのメインシリーズ！】\n海と帆船が活躍した煌びやかで生々しい時代。\nケートス海賊団の生き残りであるアドニスは、とある縁から西の国の私掠船、プリンセス･ブルーアネモネ号の船長となった。\n幼馴染のビル、駆け出し医師ペトラ、訳あり貴族のランポート、戦闘舞踊民族のパンガらとともに、行く方不明となった妹イヴを探す旅に出る。\n癖の強い船員たちの織りなす日常や冒険、人間ドラマを描いた長編シリーズ。",
        ...
        characters: [
          ...
          },
          {
            ...
            role: "船大匠",
            description:
              "貧民街の生まれで過酷な幼少期をすごす。\n文字も読めず言葉もまともに発せなかったが、まだ海賊の卵だったアドニスと妹イヴに出会い、生きる術を教わった。\n自身を地獄から救い出してくれた二人に恩を感じており、以来忠誠を尽くしている。\n無口だが情に厚い男。",
          ...
          { name: "イヴ", 
            role: "—", 
            description: "アドニスの妹。\nケートス海賊団が処刑された際、アドニスと離れ離れになった。\nアドニスが15歳、イヴが13歳のときであった。\n目が見えない。\n青いアネモネの花が好き。", 
            image: "/characters/eve.jpg" 
          },
          {
            name: "ソフィア（19）",
            role: "商家の令嬢",
            description: "港町の交易を支配するボルトロッド家の一人娘。\nしとやかで上品なふるまいだが、父の命令に従い時に冷酷な一面を見せる。\n貿易で成りあがった一族とされているが、実際は闇取引や人身売買を生業として莫大な富を築きあげていることを知っている。\nアドニスには因縁があり、命を狙っている。",
            image: "/characters/sophia.jpg",
          },
          { name: "エリカ", 
            role: "侍女", 
            description: "ソフィアの親友であり侍女。\nアドニスを殺そうとしたオルドの計画に巻き込まれて死んでしまった。\nソフィアはアドニスがエリカを殺したと思っている。", 
            image: "/characters/elica.jpg" 
          },
          { name: "テオドロス（15）", 
            role: "奴隷", 
            description: "将軍家の生まれだが、家が逆賊として告発され一族郎党処刑されてしまう。\n幼くして奴隷商に売られ、闘技会に剣闘士奴隷として出場させられたが、いつか迎えに来るという母の最後の言葉を信じてその無類の戦闘の才能で生き残り続けた。\nこれまで戦って勝つことが全てだった彼曰く、ソフィアに買われてからは毎日が新鮮でふわふわした感じらしい。", 
            image: "/characters/theo.jpg" 
          },
          {
            name: "オルド・ポルトロッド",
            role: "商人",
            description: "一代でポルトロッド家を国一番の商家に押し上げた男。\n冷酷非情な商人で、取引相手を平然と裏切ることもいとわない。\n国の海運を掌握しており、王侯貴族でさえ手が出せない。\n近年、グッドマン伯爵が密かに行動しているのではと勘ぐっている。",
            image: "/characters/ordo.jpg",
          },
          {
            name: "ケートス",
            role: "海賊",
            description: "北の海の荒くれもの、ケートス海賊団の団長。\n突如として現れ、瞬く間に海を震え上がらせた。\nその手段は凶悪無慈悲だったと伝えられているが、妻ミラとの出会いからかつての落ち着きを取り戻した。\n子煩悩な父親であり、子どものために海賊を退こうとした隙をかつての友オルドに裏切られてしまう。",
            image: "/characters/cetus.jpg",
          },
          { name: "ミラ", 
            role: "—", 
            description: "赤髪の乙女。\nケートスの心臓の赤い星。\n海に身投げする瞬間をケートスに見初められた。\nミラは本名ではなくケートスが与えた名前で、自身の出自については語らなかった。", 
            image: "/characters/mira.jpg" 
          },
          { name: "グッドマン", 
            role: "伯爵", 
            description: "私掠船プリンセス・ブルーアネモネ号の出資者。\n娘を失ってから数年間、社交界から姿を消していたが、オルドの横暴に対抗すべく自身の私掠船団を立ち上げた。\n旧友ケートスの息子であるアドニスを手助けしたいと思っている。", 
            image: "/characters/user.png" 
          },
        ],
      },
      {
        ...
        summary: "地獄の王ルシファーと、彼に尻を追いかけられる下級悪魔のミリオン･ダラ。\n人間界でメンヘラ女子大学生淡香と過激な交際をしている九官鳥の悪魔グラクラ。\n永遠の餓えという苦しみを負う暴食の悪魔ベルゼブブなど、地獄で暮らす悪魔たちの関係をコミカルにもシリアスにも描いたシリーズ。",
        ...
        characters: [
          ...
          },
          {
            ...
            role: "人間",
            description:
              "グラクラの恋人で愛が重ための女子大学生。\n幼少期、両親を殺され、虐待から解放されたことをきっかけにグラクラに惚れ、執拗に探し続けついに大学で再会を果たした。\nグラクラが人間でないことは割とどうでもよく、自分さえ見ててくれればそれでいいと思っている。\nふらふらしがちなグラクラにキレて何回も刺したことがある。",
            image: "/characters/awaka.jpg",
          },
          {
            name: "ミリオン",
            role: "半悪魔",
            description:
              "人間の母、悪魔の父を持つ。\n父であるギムレットに母親を殺され、赤子の妹とともに逃げ惑っていたところをアスモデウスに拾われた。\nギムレットや自身を蔑視する他の悪魔から隠れるように暮らしていたが、傲慢なルシファーに感化され現状を脱することを決意する。\n宿敵であるギムレットを打倒したのち、ルシファーに惚れられてしまった。",
      ...
      },
      {
        ...
        summary: "人類と魔族との最終決戦の後、勇者と魔王の間で平和交渉が行われた。\n勇者コスモ、戦乙女ヴィヴィアン、魔術師モニカ、武器職人エドは戦いを終え穏やかな日常を...と思っていたが、世間知らずの魔王、側近のアマンダを加え、どたばたな日々を過ごすことに。\n果たしてコスモに穏やかな日常は訪れるのだろうか...",
